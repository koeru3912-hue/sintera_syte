...
export default function NotFoundPage() {
  ...
  return (
    <>
      <Helmet>
        <title>404 — {t('notFound.title')} — Syntera</title>
      </Helmet>
      <div style={{
        paddingTop: 120,
        paddingBottom: 80,
        ...
        <p style={{ color: 'var(--t3)', fontSize: 13, marginTop: 12 }}>
          {t('notFound.callUs')} <a href={PHONE_HREF} style={{ color: 'var(--blue)', fontWeight: 600 }}>{PHONE}</a>
        </p>
        <InlineLeadForm />
      </div>
    </>
